...
def true_bounce_signal(st: dict) -> Optional[str]:
    ...
    min_depth_ratio = BOUNCE_THRESHOLD_PCT * 0.03  # 3% of threshold distance
...
if __name__ == "__main__":
    ...
    logging.info(f"STRATEGY PRIORITY: 1st=BOUNCE (strict Donchian thresholds), 2nd=BREAKOUT (strict Donchian)")
