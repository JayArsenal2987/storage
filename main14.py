...
# MA_PERIODS is used for DEMA and HULL (JMA uses JMA_LENGTH_CLOSE and JMA_LENGTH_OPEN)
MA_PERIODS = DEMA_PERIODS if MA_TYPE in ["DEMA", "HULL"] else max(JMA_LENGTH_CLOSE, JMA_LENGTH_OPEN)
...
def calculate_ma(symbol: str, field: str, period: int) -> Optional[float]:
    ...
    if MA_TYPE == "JMA":
        # Use different JMA lengths for close vs open
        jma_length = JMA_LENGTH_CLOSE if field == "close" else JMA_LENGTH_OPEN
